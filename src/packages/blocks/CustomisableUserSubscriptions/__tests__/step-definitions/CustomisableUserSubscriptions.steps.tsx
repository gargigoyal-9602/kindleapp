...
const feature = loadFeature('./__tests__/features/CustomisableUserSubscriptions-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to CustomisableUserSubscriptions', ({ given, when, then }) => {
        let exampleBlockA:ShallowWrapper;
        let instance:CustomisableUserSubscriptions; 

        given('I am a User loading CustomisableUserSubscriptions', () => {
            exampleBlockA = shallow(<CustomisableUserSubscriptions {...screenProps}/>)
        });

        when('I navigate to the CustomisableUserSubscriptions', () => {
             instance = exampleBlockA.instance() as CustomisableUserSubscriptions
        });
