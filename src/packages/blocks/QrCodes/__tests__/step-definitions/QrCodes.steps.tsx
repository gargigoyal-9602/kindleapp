...
const feature = loadFeature('./__tests__/features/QrCodes-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to QrCodes', ({ given, when, then }) => {
        ...
        given('I am a User loading QrCodes', () => {
            exampleBlockA = shallow(<QrCodes {...screenProps}/>)
        });

        when('I navigate to the QrCodes', () => {
             instance = exampleBlockA.instance() as QrCodes
        });
