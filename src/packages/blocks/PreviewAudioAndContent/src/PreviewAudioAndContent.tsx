...
import PreviewAudioAndContentController, {
  Props,
  configJSON
} from "./PreviewAudioAndContentController";

export default class PreviewAudioAndContent extends PreviewAudioAndContentController {
