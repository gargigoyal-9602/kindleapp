...
> {
  ...
  goToChangePasswordAfterOtp = async (values: { otpCode: string }) => {
  ...
  goToConfirmationAfterPasswordChange = async (values: any) => {
    function useQuery() {
    ...
    const token = await StorageProvider.get("resetToken");
