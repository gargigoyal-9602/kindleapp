...
class buyNotesPreview extends HomeController {
  ...
  render() {
    ...
    const BookNotes =
      this.state.BookNotesForPurchased && this.state.BookNotesForPurchased;
    return (
      <>
        ...
        <div className="catalog-book">
          ...
          <div className="content">
            ...
            <p className="color-gray">
              {(BookNotes && BookNotes.attributes.notes.length) || 0} Books
              Available
            </p>
            {BookNotes && BookNotes.attributes.notes.length > 0 && (
              <div className="row buy-notes-page buy-notes-preview">
...
//@ts-ignore
const buyNotesPreviewRouter = withRouter(buyNotesPreview);
const buyNotesPreviewTheme = withTheme(buyNotesPreviewRouter);
export default withStyles(styles)(buyNotesPreviewTheme);
