              ...
              <div className="row w-100">
                {this.state.allNotes &&
                  ...
                  this.state.allNotes.map((x: any, index: any) => {
                    return (
                     x.attributes.notes[0].attributes.notes_count >0 &&  <div className="card_blocks col-xs-12 col-sm-6 col-xl-4" id="card_blocks">
                        <div className="card">
                          <div className={`list ${this.props.mode && "dark1"}`}>
                            ...
                            <img
                              ...
                              onClick={() => {
                                //@ts-ignore
                                this.props.history.push(`/viewMynotes/${x.id}`);
                              }}
                            />
                          </div>
                        </div>
...
//@ts-ignore
const MyNotesRouter = withRouter(MyNotes);
const MyNotesTheme = withTheme(MyNotesRouter);
export default withStyles(styles)(MyNotesTheme);
