...
import PdfToEpubConvertedIntegrationController, {
  Props,
  configJSON
} from "./PdfToEpubConvertedIntegrationController";

export default class PdfToEpubConvertedIntegration extends PdfToEpubConvertedIntegrationController {
