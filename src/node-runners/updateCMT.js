...
var postData = JSON.stringify({"mobile_ide_url_setting":{"gitlab_project_id":GIT_LAB_ID,"android_app_location":`${URL_PREFIX}_Android.apk`,"ios_app_location":`${URL_PREFIX}_iOS.zip`}});
